...
/**
 * Self enrolment plugin - support for user  teacherskey unenrolment.
 *
...
$instance = $DB->get_record('enrol', array('id'=>$enrolid, 'enrol'=>'teacherskey'), '*', MUST_EXIST);
...
$plugin = enrol_get_plugin('teacherskey');
...
$PAGE->set_url('/enrol/teacherskey/unenrolself.php', array('enrolid'=>$instance->id));
