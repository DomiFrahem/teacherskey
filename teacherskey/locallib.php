...
class teacherskey_from extends moodleform {
    ...
    public function get_fio_default_value($userid, $courseid) {
        ...
        if ($DB->record_exists('teacherskey_data', array('userid' => $userid, 'courseid' => $courseid))) {
            return $DB->get_record('teacherskey_data', array(array('userid' => $userid, 'courseid' => $courseid)));
    ...
    public function definition()
    {
        ...
        $myform->addElement('checkbox', 'truetechers', get_string('truetechers', 'enrol_teacherskey'), null, array('onchange' => 'change(this)'));
